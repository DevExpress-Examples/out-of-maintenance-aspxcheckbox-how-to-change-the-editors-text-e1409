<%@ Page Language="vb" AutoEventWireup="true" CodeFile="default.aspx.vb" Inherits="checkBox" %>
...
function UpdateCheckBoxText(s, e){
	if (s.GetChecked()){
		...
		<dxe:aspxcheckbox id="ASPxCheckBox1" runat="server" text="I have read and agree to the ..." Value='<%#Nothing%>'>
